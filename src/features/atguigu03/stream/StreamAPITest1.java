package features.atguigu03.stream;

import features.atguigu02.reference.data.Employee;
import features.atguigu02.reference.data.EmployeeData;
...
//        skip(n) —— 跳过元素，返回一个扔掉了前 n 个元素的流。若流中元素不足 n 个，则返回一个空流。与 limit(n) 互补
        list.stream().skip(5).forEach(System.out::println); //跳过前5个元素
